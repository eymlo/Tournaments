...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { description: @league.description, end_date: @league.end_date, name: @league.name, start_date: @league.start_date }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { description: @league.description, end_date: @league.end_date, name: @league.name, start_date: @league.start_date }
    assert_redirected_to league_path(assigns(:league))
  end
